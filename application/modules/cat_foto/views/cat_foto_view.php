   ...
   <script type="text/javascript">
	 ...
	 function Ubah_Data(id){
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>cat_foto/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('cat_foto/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
	     ...
	     var formData = new FormData($('#user_form')[0]); 
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>cat_foto/simpan_data",
             type:"POST",
             data:formData,
	 ...
	 $('.datepicker').bootstrapMaterialDatePicker({
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable( {
			"ajax": "<?php echo base_url(); ?>cat_foto/fetch_cat_foto" 
		});
