                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
						...
						<table class="table table-responsive">
							...
							<tr>
								<td style="font-weight:bold;"> Foto client  </td> 
								<td colspan="4">  : </td> 
							</tr> 
							<tr>
								<td colspan="6" align="center">  
								<img src="" class="img responsive" id="foto_client_dtl">
								</td>
							</tr>
...
function get_filesize(url, callback) {
   ...
   <script type="text/javascript">
	 ...
	 function Ubah_Data(id){
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>client/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('client/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
        ...
        var deskripsi = tinymce.get('deskripsi').getContent();
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>client/simpan_data",
             type:"POST",
	 ...
	 $('.datepicker').bootstrapMaterialDatePicker({
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable( {
			"ajax": "<?php echo base_url(); ?>client/fetch_client" 
		});
